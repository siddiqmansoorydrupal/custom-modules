...
class MediaLibraryTest extends WebDriverTestBase {
  ...
  public function testButton() {
    ...
    // Since version 10.1.0 media items are aligned to the left by default.
    // @see https://www.drupal.org/node/3328698
    if (version_compare(\Drupal::VERSION, '10.1.0-dev', '<')) {
      $expected_attributes['data-align'] = 'center';
    }
